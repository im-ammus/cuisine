...
const Home = () => {
    ...
    return (
      ...
      <h1  className='text-5xl font-bold text-yelllow-600 m-3'></h1>

        {
          loading ?
          <div className='flex justify-center items-center my-5 text-lg'>
            <img width={'70px'} height={'70px'} src="https://media.tenor.com/kMCwoAD4RNAAAAAi/loading-gif-loading.gif" alt="loading" />Loading...
          </div>
          :
          <>
          <div className='grid grid-cols-4 gap-4'>
            {
              ...
              <div className='text-center'>
                ...
                <Link className='bg-green-500 rounded p-1 mt-3 text-white inline-block' to={`${recipes?.id}/view`}>View More..</Link>
              </div>
            </div>
              ))
              :
