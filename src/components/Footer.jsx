...
const Footer = () => {
  return (
    <div style={{ height: '300px' }} className='w-full bg-green-500 pt-20 pl-10'>
    <div className="flex justify-between font-bold">
      <div style={{ width: '400px' }} className="intro">
        <h5><i class="fa-solid fa-burger"></i> <span className='font-bold text-white'>Flavor Fusion</span></h5>
